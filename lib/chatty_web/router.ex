defmodule ChattyWeb.Router do
  ...
  import ChattyWeb.UserAuth

  pipeline :browser do
    plug :accepts, ["html"]
    plug :fetch_session
    plug :fetch_live_flash
    plug :put_root_layout, html: {ChattyWeb.Layouts, :root}
  ...
  if Application.compile_env(:chatty, :dev_routes) do
  ...
  scope "/", ChattyWeb do
    ...
    live_session :redirect_if_user_is_authenticated,
      on_mount: [{ChattyWeb.UserAuth, :redirect_if_user_is_authenticated}] do
  ...
  scope "/", ChattyWeb do
    ...
    live_session :current_user,
      on_mount: [{ChattyWeb.UserAuth, :mount_current_user}] do
